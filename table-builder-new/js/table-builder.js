$(function(){
    ...
    function tableBuild() {
        ...
        tableBuilder.append('<button class="add-col button">Add Column</button>' +
                            '<button class="add-row button">Add Row</button>' +
                            '<button class="save button">Save</button>' +
                            '<div class="controls"><button class="button merge-group">Merge Column Cells</button><button class="button merge-across">Merge Row Cells</button></div>' +
                            '<div class="columns"></div><div class="rows"></div>');
          
        builderWrap.append(tableBuilder);
        builderWrap.append('<table id="preview-table"><thead><tr></tr></thead><tbody></tbody></table>');
    }
    ...
    function tableStart() {
        tablePathStepOne.append('<h1>Create a new table</h1>' +
                                '<button class="button new-table">New Table</button>' +
                                '<button class="button import-table">Import Table</button>' +
                                '<button class="button table-wizard">Table Wizard</button>');
